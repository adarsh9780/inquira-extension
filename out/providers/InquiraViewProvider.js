...
exports.InquiraViewProvider = void 0;
...
const CodeInjector_1 = require("../services/CodeInjector");
class InquiraViewProvider {
    constructor(_extensionUri) {
        ...
        this._llmService = new LLMService_1.LLMService();
        this._schemaManager = new SchemaManager_1.SchemaManager();
        this._codeInjector = new CodeInjector_1.CodeInjector();
    }
    getSettingsPath() {
    ...
    async loadMessages(limit = 4, offset = 0) {
        try {
    ...
    async _updateSettings(apiKey, dataPath, context, model) {
        const settings = this.loadSettings();
        if (apiKey)
...
exports.InquiraViewProvider = InquiraViewProvider;
InquiraViewProvider.viewType = 'inquiraview';
function getNonce() {
    let text = '';
...
//# sourceMappingURL=InquiraViewProvider.js.map